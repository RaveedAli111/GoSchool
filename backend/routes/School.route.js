...
router.route("/list").get(catchErrors(school.list));
router.route("/create").post(catchErrors(school.create));
router.route("/update/:id").put(catchErrors(school.update));
router.route("/delete/:id").delete(catchErrors(school.delete));
router.route("/read/:id").get(catchErrors(school.read));
router.route("/search").get(catchErrors(school.search));
